...
namespace UniTransport.DAL.Migrations
{
    ...
    [Migration("20250115084832_UpdateEntityRelationships")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UniTransport.DAL.Entities.Booking", b =>
                {
            ...
            modelBuilder.Entity("UniTransport.DAL.Entities.RequestedTrip", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("RequestedTripId"));
            ...
            modelBuilder.Entity("UniTransport.DAL.Entities.Trip", b =>
                {
                    ...
                    b.HasIndex("RequestedTripId")
                        .IsUnique()
                        .HasFilter("[RequestedTripId] IS NOT NULL");
            ...
            modelBuilder.Entity("UniTransport.DAL.Entities.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("UniTransport.DAL.Entities.Vehicle", b =>
                {
                    b.Property<int>("VehicleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("UniTransport.DAL.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("UniTransport.DAL.Entities.Booking", b =>
                {
                    ...
                    b.HasOne("UniTransport.DAL.Entities.Trip", "Trip")
                        .WithMany("Bookings")
            ...
            modelBuilder.Entity("UniTransport.DAL.Entities.Trip", b =>
                {
                    b.HasOne("UniTransport.DAL.Entities.RequestedTrip", "RequestedTrip")
                        .WithOne()
                        .HasForeignKey("UniTransport.DAL.Entities.Trip", "RequestedTripId")
                        .OnDelete(DeleteBehavior.NoAction);
